...
export const services: Service[] = [
  {
    ...
    details: [
      ...
      'Art advisory & interior styling',
      'Space optimization & structural space-planning',
  ...
  },
  {
    ...
    details: [
      ...
      'Lobby & public space zoning',
      'Custom bar & dining furniture designs',
      'Atmospheric lighting & material specifications'
    ]
  },
  {
    id: 'office',
    ...
    details: [
      ...
      'Biophilic integrations & moss walls',
      'Ergonomic seating & desk layouts',
      'Smart office technology integrations'
    ]
  },
  {
    id: 'kitchens',
    ...
    details: [
      ...
      'Integrated professional-grade appliances',
      'Custom pantry & storage systems',
      'Concealed lighting & smart task illumination'
    ]
  }
];
